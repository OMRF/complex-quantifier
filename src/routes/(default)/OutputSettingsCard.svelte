<script context="module" lang="ts">
    ...
    export const saveFolder = writable<FileSystemDirectoryHandle | null>(null)
...
<script lang="ts">
    import { Icon, Folder, XCircle, Check } from 'svelte-hero-icons'
    ...
    <Card.Content>
        <div class="flex flex-col space-y-8">
            ...
            <div class="flex flex-col space-y-1.5">
                ...
                <Input bind:value={$filenamePattern} />
