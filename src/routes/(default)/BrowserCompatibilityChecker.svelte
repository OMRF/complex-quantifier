<script lang="ts">
    ...
    let unsupportedFeatures: typeof features = []
    onMount(() => {
        unsupportedFeatures =
     features.filter(feature => !feature.supported())
    })
</script>
    ...
    <AlertDialog.Content>
        <AlertDialog.Header>
            ...
            <AlertDialog.Description>
                Your browser lacks support for the modern File System API. These features were not found in your
                browser:
            </AlertDialog.Description>
